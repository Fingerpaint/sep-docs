...
\feedbackTableStart{\femke}
\setVersion{0.1}
1.3	 & Incorrect & 2IP35 is the Software Engineering Project, not a Course (also, remove the dot at the end of the sentence, please) \\
1.3	 & Other & You don't have to translate BCF: its English equivalent meaning is namely ``Bureau for Computer Facilities". \\
1.4	 & Missing	 & The list of references is emtpy.
\end{longtable}
...
4.3.2 & Typo & In the second paragraph, ``et cetera" should be ``etcetra".
