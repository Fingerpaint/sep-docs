...
\AT[loadDist]{CPR13}{Verify that a user can load a previously saved concentration distribution in the drawing area.}
...
\AT[defDist]{CPR6, CPR7, CPR8, CPR9, CPR10}{Verify that a user can define a concentration distribution by drawing in the drawing area.}
...
\AT[saveDist]{CPR11}{Verify that a user can save a concentration distribution.}
...
\AT[loadProt]{CPR24}{Verify that a user can load a previously saved mixing protocol.}
...
\AT[execSingleStep]{CPR17, CPR18, CPR20, CPR25, CPR26, CPR27}{Verify that a user can define and execute a single mixing step on an initial concentration distribution.}
...
\AT[execProt]{CPR17, CPR18, CPR19, CPR20, CPR21, CPR25, CPR26, CPR27, CPR29}{Verify that a user can define and execute mixing protocol on an initial concentration distribution.}
...
\AT[saveRun]{CPR30}{Verify that a user can save the results of a mixing run.}
